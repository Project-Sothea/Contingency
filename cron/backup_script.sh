...
# To run it every minute, add the following line to your crontab -e:
# * * * * * /bin/bash /absolute_path/to/backup_script.sh

# Set PostgreSQL connection parameters
PGHOST="localhost"
PGUSER="jieqiboh"               # Replace with your PostgreSQL username
PGPASSWORD="postgres"        # Replace with your PostgreSQL password
PGDATABASE="patients"            # Replace with your database name

# Generate timestamp
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")   # Format: YYYYMMDD_HHMMSS
OUTPUT_PATH="./backups/${TIMESTAMP}_patientdata.csv"  # Replace with the desired path for the output CSV file

# Execute the query and export the result to CSV
